...
std::tuple<CmdRes, std::string> do_get(const std::vector<std::string_view>& cmd) {
...
std::tuple<CmdRes, std::string> do_set(const std::vector<std::string_view>& cmd) {
    g_map[std::string(cmd[1])] = std::string(cmd[2]);
    return std::make_tuple(CmdRes::RES_OK, std::string());
}
std::tuple<CmdRes, std::string> do_del(const std::vector<std::string_view>& cmd) {
